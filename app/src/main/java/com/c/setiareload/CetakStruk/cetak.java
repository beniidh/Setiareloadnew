...
public class cetak extends AppCompatActivity {
    ...
    private void saveImage() {
        ...
        Bitmap bmp = Bitmap.createBitmap(300, 340, Bitmap.Config.ARGB_4444);
        ...
        canvas.drawText("Struk ini merupakan bukti pembayaran yang sah ", 10, 250,paint);
        canvas.drawText("mohon disimpan,Terimakasih", 60, 270,paint);
