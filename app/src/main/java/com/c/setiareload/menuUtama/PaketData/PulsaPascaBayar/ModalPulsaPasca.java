package com.c.setiareload.menuUtama.PaketData.PulsaPascaBayar;
...
import com.c.setiareload.menuUtama.PaketData.air.AdapterAir;
import com.c.setiareload.menuUtama.PaketData.air.MAir;
import com.google.android.material.bottomsheet.BottomSheetDialogFragment;

import java.util.ArrayList;

public class ModalPulsaPasca extends BottomSheetDialogFragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            bottomSheetListenerProduksms = (ModalPulsaPasca.BottomSheetListenerProduksms) context;
