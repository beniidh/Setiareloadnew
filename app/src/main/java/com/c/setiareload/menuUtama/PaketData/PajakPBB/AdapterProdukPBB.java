...
import com.c.setiareload.menuUtama.PaketData.TransaksiHandle.DetailTransaksiPasca;
...
public class AdapterProdukPBB extends RecyclerView.Adapter<AdapterProdukPBB.ViewHolder> {

    Context context;
    ArrayList<ResponProdukPBB.VoucherData> mVoucherProduk;
    String nomor, type;

    public AdapterProdukPBB(Context context, ArrayList<ResponProdukPBB.VoucherData> mVoucherProduk, String nomor, String type) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterProdukPBB.ViewHolder holder = new AdapterProdukPBB.ViewHolder(v);
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ResponProdukPBB.VoucherData mVoucherData = mVoucherProduk.get(position);
