...
public class AdapterProdukTV extends RecyclerView.Adapter<AdapterProdukTV.ViewHolder> {

    Context context;
    ArrayList<ResponProdukTV.VoucherData> mVoucherProduk;
    String nomor, type;

    public AdapterProdukTV(Context context, ArrayList<ResponProdukTV.VoucherData> mVoucherProduk, String nomor, String type) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterProdukTV.ViewHolder holder = new AdapterProdukTV.ViewHolder(v);
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ResponProdukTV.VoucherData mVoucherData = mVoucherProduk.get(position);
