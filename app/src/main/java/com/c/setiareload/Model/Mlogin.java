...
public class Mlogin {
    ...
    public Mlogin(String server_id,String credentials, String password, String push_notif_id, String ip_address,String mac_address, String user_agent, Double longitude, Double latitude) {
