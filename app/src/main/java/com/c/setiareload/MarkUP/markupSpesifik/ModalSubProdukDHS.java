...
import com.c.setiareload.DaftarHarga.AdapterSubProdukDH;
...
public class ModalSubProdukDHS extends BottomSheetDialogFragment {


    RecyclerView recyclerViewK;
    AdapterSubProdukDHM adapterSubProdukDH;
    ArrayList<ResponSubProdukDHM.mData> mData = new ArrayList<>();
    Button tutup, pilih;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterSubProdukDH = new AdapterSubProdukDHM(getContext(), mData);
    ...
    private void getProdukDHsub(String id) {
        ...
        Call<ResponSubProdukDHM> call = api.getProdukDHsubM(token,id);
        call.enqueue(new Callback<ResponSubProdukDHM>() {
            @Override
            public void onResponse(Call<ResponSubProdukDHM> call, Response<ResponSubProdukDHM> response) {
            ...
            @Override
            public void onFailure(Call<ResponSubProdukDHM> call, Throwable t) {
