...
import com.c.setiareload.DaftarHarga.AdapterProdukDH;
...
public class ModalProdukDHS extends BottomSheetDialogFragment {
    ...
    Button tutup, pilih;
    private BottomSheetListenerProduk bottomSheetListenerProduk;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterProdukDH = new AdapterProdukDHM(getContext(), mData);
