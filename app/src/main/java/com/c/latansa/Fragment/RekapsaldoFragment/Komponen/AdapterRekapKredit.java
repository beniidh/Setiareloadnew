...
public class AdapterRekapKredit extends RecyclerView.Adapter<AdapterRekapKredit.ViewHolder> {
    ...
    public AdapterRekapKredit(Context context, ArrayList<responRekap.Data.Item> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterRekapKredit.ViewHolder holder = new AdapterRekapKredit.ViewHolder(v);
        return holder;
    }
