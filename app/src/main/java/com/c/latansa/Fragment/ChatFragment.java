        ...
        WaCenter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isWhatappInstalled()){
                    Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone="+"+6285655555587"+
                            "&text="+"hallo saya.."));
                    startActivity(i);
        ...
        teleGramCenter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isTelegramInstalled()) {
                    Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://telegram.me/loketPulsa"));
                    startActivity(i);
