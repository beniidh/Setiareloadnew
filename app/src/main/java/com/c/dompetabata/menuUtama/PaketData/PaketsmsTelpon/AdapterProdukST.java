...
public class AdapterProdukST extends RecyclerView.Adapter<AdapterProdukST.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.linearklik.setOnClickListener(v -> {
            ...
            MInquiry mInquiry = new MInquiry(msmsTelpon.getCode(), nomor, "PRABAYAR", Value.getMacAddress(), Value.getIPaddress(), Value.getUserAgent(context), gpsTracker.getLatitude(), gpsTracker.getLongitude());
